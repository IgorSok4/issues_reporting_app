<?php
include 'header.php';
include '../backend/fetch_user_reports.php';
            ...
            <div class="row pt-5">
                <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto" style="margin-bottom: 63px;">
                    <div class="text-center">
                        <p class="fw-bold text-success mb-2">MOJE AKTUALNE ZGŁOSZENIA</p>
        ...
        <div class="col-xl-10">
            <div class="card" style="background: rgba(0,0,0,0.125);">
                <div class="card-header d-flex flex-wrap justify-content-center align-items-center justify-content-sm-between gap-3" style="background: #27262e;">
                    <h1 class="display-6 text-nowrap text-capitalize mb-0" style="font-family: Inter, sans-serif;font-size: 32px;"><strong><span style="background-color: rgba(0, 0, 0, 0.125);">Moje Zgłoszenia</span></strong></h1>
                                ...
                                <?php foreach ($reports as $report): ?>
                                    <tr>
                                        ...
                                        <td class="text-center" style="background: rgb(255,255,255);">
                                            <a href="user_report_detail.php?id=<?php echo $report['id']; ?>">
