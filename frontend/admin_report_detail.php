        ...
        <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
            <div class="col">
                <div class="d-flex">
                    ...
                    <div class="px-3">
                        <h4 class="text-white"><?php echo htmlspecialchars($zgloszenie['tytul']); ?></h4>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="d-flex">
                    ...
                    <div class="px-3">
                        <h4 class="text-white"><?php echo htmlspecialchars($zgloszenie['nazwa_kategorii']); ?></h4>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="d-flex">
                    ...
                    <div class="px-3">
                        <h4 class="text-white"><?php echo $zgloszenie['piorytet'] == 1 ? 'Piorytet' : 'Bez piorytetu'; ?></h4>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="d-flex">
                    ...
                    <div class="px-3">
                        <h4 class="text-white"><?php echo htmlspecialchars($zgloszenie['imie_nazwisko']); ?></h4>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="d-flex">
                    ...
                    <div class="px-3">
                        <h4 class="text-white"><?php echo htmlspecialchars($zgloszenie['oddzial']); ?></h4>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="d-flex">
                    ...
                    <div class="px-3">
                        <h4 class="text-white"><?php echo htmlspecialchars($zgloszenie['login_uzytkownika']); ?></h4>
                    </div>
                </div>
            </div>
        </div>
